...
**`packages/cli`의 공개 계약과 배선 책임의 정본.** 작성일: 2026-08-06 · 최종 개정: 2026-08-11(§1·§6 — 배럴의 지위와 소속 기준, 재개 트랜스크립트 표면의 소유) · 상태: 설계 확정, 구현 완료(검색 제외 — `SEARCH.md` 참조).
