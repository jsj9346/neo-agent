...
**이 문서가 컨텍스트 압축의 정본이다.** 작성일 2026-08-06. `ARCHITECTURE.md` §2.4가 "유일한 예외"로 예약해 둔 압축의 실체이자, REUSE-MAP §2.4·§3에서 🕐 후순위로 판정했던 항목의 채택 설계다. 사용자 확인 4건(요약 형태 / 분기 저장 / 유지 정책 / 트리거) 전부 권장안 채택 — 근거는 `devlog.md` 2026-08-06.
