 ...
 * 거부가 걸린다 — §3.5의 표현으로 *"`--version`도 예외가 아니다"*. 그 거부를 지나가는 갈래의
 * 목록은 이 주석이 지지 않는다 — 정본은 `CLI-INTERFACE.md` §2.2 계약 5이고, **여기에 수를
 * 적지 않는다**(2026-09-06에 `doctor`가 둘째로 들어오며 이 자리의 옛 서술이 거짓이 됐다).
