...
// ───────────────────────────────────────────────────────────────────────────
// Q6. 주입 싱크의 폭 (CLI-INTERFACE §1 — 2026-08-24 판정)
// ───────────────────────────────────────────────────────────────────────────

describe("QA — 고지 싱크가 받는 것의 범위 (CLI-INTERFACE §1)", () => {
  /**
   * 이 자리의 SM-1 마커는 걷혔다 — 그것이 물은 것은 **범위와 예외 규율** 둘이었고
   * `CLI-INTERFACE.md` §1이 2026-08-24에 둘 다 판정했다. 범위는 아래 단언이 재고
   * 예외 귀속은 Q8이 잰다. **마커 표기를 여기 다시 적지 않는다** — `MARKERS.md` §3.3이
   * 표기 하나를 열린 판정 하나로 세므로, 걷었다는 서술이 표기를 물고 있으면 계수가
   * 안 줄어든다.
   *
